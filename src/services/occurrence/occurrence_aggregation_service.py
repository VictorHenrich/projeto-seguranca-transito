...
from repositories.occurrence import OccurrenceAggregateRepository, OccurrenceAggregateRepositoryParams
...
class OccurrenceAggregationService:
    def __init__(self, user: User) -> None:
        self.__occurrence_filter: OccurrenceAggregateProps = OccurrenceAggregateProps(user)

    def __handle_occurrence_data(self, occurrence_data: OccurrenceAggregateItemType) -> Mapping[str, Any]:
    ...
    def __find_occurrences(self, session: Session) -> Collection[Mapping[str, Any]]:
        occurrence_aggregate_repo: IFindManyRepository[OccurrenceAggregateRepositoryParams, OccurrenceAggregateItemType] = OccurrenceAggregateRepository(session)

        occurrences: Collection[OccurrenceAggregateItemType] = occurrence_aggregate_repo.find_many(self.__occurrence_filter)
